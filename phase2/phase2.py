...
com_combobox = ttk.Combobox(main_frame, values=rates, state="readonly", textvariable=baud_rate)
com_combobox.set(rates[0])
com_combobox.grid(column=1, row=2, sticky=(tk.W))
